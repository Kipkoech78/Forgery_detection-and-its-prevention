...
<form action="add_customer.php" method="POST">
            <table align="center">
                ...
                <tr>
                  <td><span class="style1">Type</span></td>
                  <td><select name="type"  class="required" required x-moz-errormessage="Select A type" style="background-color:#CCC">
