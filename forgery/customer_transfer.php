  ...
  text-align:center;
    ...
    font-weight:bold;
        ...
        <h3 style="text-align:center;color:#2E4372;"><u>Transfer Funds</u></h3>
                    ...
                    //if(isset($_SESSION['login_id']==$account_no)){
                    if(isset($_SESSION['customer_login']))
                    {
                        if (isset($_SESSION["login_id"])) 
{
     $sender_id=$_SESSION["login_id"];
        //$_SESSION['customer_login']=$sender_id;
        //$cust=
       ...
       //$s_id=$rws[1];
        ...
        {
        echo "<form action='customer_transfer_process.php' method='GET'>";
        ...
        echo "<tr><td>Enter Amount: </td><td><input type='integer' name='t_val' required></td></table>";
